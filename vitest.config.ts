 ...
 * documented alternative — mocking globalThis.fetch — does not work here: the
 * request under test is issued inside PactBrokerDO.fireWebhook(), and the
 * "global mocks apply" guarantee only covers the main worker's isolate, not a
 * Durable Object's. outboundService intercepts at the runtime level, which is
 * where fetchMock used to sit.
 *
